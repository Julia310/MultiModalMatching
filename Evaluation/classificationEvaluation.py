...
def f_measure(num_tp, num_fn, num_fp, num_tn):
    """
...
def matching_evaluation(db_context, m_utilites):
    ...
    logging.info('Calculating confusion matrix : \n' + str(np.array([[num_tp, num_fn], [num_fp, num_tn]])))
    print('')

    logging.info('Linkage evaluation:')
